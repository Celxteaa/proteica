...
app.post('/api/analisis-protein', async (req, res) => {
    ...
    *Wajib gunakan format persis seperti ini dan dengan kelonggaran untuk menambah jika kurang dari target protein dan mengurangi jika lebih dari target protein, tapi tetap realistis dan masuk akal dan perhitungan susunan protein WAJIB dihitung total secara sinkron:*
    ...
    **Total Protein:** [Hasil X + Y + Z] gram. (WAJIB mendekati target ${targetProtein} gram dan protein yang dijumlahkan WAJIB akurat/sinkron dengan yang disebutkan)*
    *jika kurang atau lebih dari target, beri tahu di akhir menu: "Total protein dari menu ini [lebih/kekurangan] [jumlah kekurangan atau kelebihan gram protein] dari target harian Anda, [jika jumlah protein kelebihan dari target dan status tubuh kurus atau underweight berikan saran kalau makan sedikit lebih banyak dari target protein harian dapat membantu menaikkan berat badan ke berat ideal tapi perlu disesuaikan dan jika jumlah protein kurang dari target dan status tubuh kategori obesitas berikan saran kalau makan lebih sedikit dari target protein harian dapat membantu menurunkan berat badan ke ideal tapi perlu disesuaikan]."*
